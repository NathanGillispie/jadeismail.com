          ...
          {skillCategories.map((category) => {
            ...
            return (
              <div key={category.title} data-reveal>
                <div className="relative h-full p-6 bg-card rounded-lg border border-border overflow-hidden group cursor-pointer hover-lift-lg hover:border-primary">
                  <div className="absolute inset-0 bg-gradient-to-br from-primary/5 to-accent/5 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />

                  <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-6 group">
                      <div className={`p-3 rounded-lg bg-gradient-to-br ${category.color} hover-icon`}>
